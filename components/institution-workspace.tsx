...
export function InstitutionGate({ children }: { children: React.ReactNode }) {
  ...
  return <main className="min-h-screen bg-background px-4 py-10 text-foreground sm:px-8">
    <div className="mx-auto flex max-w-5xl flex-col gap-8">
      ...
      <Card className="border-primary/20 neo"><CardHeader><CardTitle>Set up your demo workspace</CardTitle><CardDescription>This frontend workspace is ready to swap for Supabase or your API later.</CardDescription></CardHeader><CardContent className="grid gap-6 lg:grid-cols-[1fr_1.4fr]">
